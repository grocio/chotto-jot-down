...
1から20までの数字はそれぞれの参加者のIDとして、それぞれの参加者のx,yの値で点がプロットされています。xが高くなるにつれてyも高くなる関係にあります。さらに、y = ax + bというような式（i.e.,回帰式）を立てて、xからyを予測/説明するということを行います。実線がその予測を表します。実際の参加者のyの値と予測されたyの値のズレが赤い波線で表されています。
